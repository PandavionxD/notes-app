    ...
    <Box display="flex" py={2}>
      ...
      <Typography flexGrow={1} variant="h3" component="h1" color="white.main">
        ...
        (
           ...
           autoFocus id="Nota" name="nota" label='Nota' variant="standard" size="small" sx={{
            display:'flex',
            flexGrow:1
           }} color="white" /> 
        )
      ...
      <IconButton  type="button" onClick={()=>setsearch(prevState=>!prevState)} size="small" color="white">
        {
          search ?
          (
            <CloseIcon
